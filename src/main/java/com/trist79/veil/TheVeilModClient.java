/*
 * The Veil Mod
 * File: TheVeilModClient.java
 * Description: Client-side main class for The Veil Mod
...
@EventBusSubscriber(modid = TheVeilMod.MODID, value = Dist.CLIENT)
public class TheVeilModClient {
    public TheVeilModClient(ModContainer container) {
